...
<nav class="navbar navbar-expand-lg fixed-top">
    ...
    <script id="lesData" type="application/json"><?= json_encode($resultLes->fetch_all(MYSQLI_ASSOC)) ?></script>
<script id="reserveringData" type="application/json"><?= json_encode($resultReservering->fetch_all(MYSQLI_ASSOC)) ?></script>
